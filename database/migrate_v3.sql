...
-- ============================================================================
-- MIGRATION V3 (base existante) : ajoute les colonnes/tables manquantes
-- Prerequis: MySQL 8+
-- ============================================================================
...
ALTER TABLE capteurs
  ADD CONSTRAINT fk_capteur_usine FOREIGN KEY (usine_id) REFERENCES usines(id);
...
CREATE UNIQUE INDEX uq_tranche_saison_type_plage
  ON tranches_horaires (saison, type_tranche, heure_debut, heure_fin);
...
CREATE UNIQUE INDEX uq_capteur_date ON mesures (capteur_id, date);
ALTER TABLE mesures
...
CREATE INDEX idx_pmc_capteur_date ON pmc_glissante (capteur_id, date);
...
ALTER TABLE depassements
  ADD CONSTRAINT fk_dep_usine FOREIGN KEY (usine_id) REFERENCES usines(id),
  ADD CONSTRAINT fk_dep_user FOREIGN KEY (acquitte_par) REFERENCES utilisateurs(id);

CREATE INDEX idx_dep_acquitte ON depassements (acquitte);
...
CREATE INDEX idx_log_source_date ON logs_systeme (source, date);
ALTER TABLE logs_systeme
